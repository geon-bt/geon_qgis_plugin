...
from qgis.core import QgsProject, QgsTask, QgsApplication, QgsMessageLog, QgsProviderRegistry, QgsDataSourceUri
...
class GwAdminButton:
    ...
    def geon_select_connection(self):
        """"""
        self.geon_projects = []
        """Set combobox list and settings for project to open"""
        self.dlg_readsql.geon_open_project.setEnabled(False)
