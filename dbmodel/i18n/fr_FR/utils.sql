...
INSERT INTO "value_state" VALUES (1,'EN_SERVICE');
INSERT INTO "value_state" VALUES (2,'PLANIFIE');
...
-- ----------------------------
INSERT INTO "value_verified" VALUES ('A VERIFIE');
INSERT INTO "value_verified" VALUES ('VERIFIE');

-- Records of value_yesno
-- ----------------------------
INSERT INTO "value_yesno" VALUES ('NON');
INSERT INTO "value_yesno" VALUES ('OUI');
...
INSERT INTO om_visit_parameter_type VALUES ('AUTRE');
...
-- ----------------------------
INSERT INTO value_priority VALUES ('PRIORITE_MAX');
INSERT INTO value_priority VALUES ('PRIORITE_NORMALE');
INSERT INTO value_priority VALUES ('PRIORITE_BASSE');

-- Records of plan_result_type
-- ----------------------------
INSERT INTO plan_result_type VALUES (1,'Reconstruction');
INSERT INTO plan_result_type VALUES (2,'Réhabilitation');

-- Records of plan_psector_cat_type
-- ----------------------------
INSERT INTO plan_psector_cat_type VALUES (1,'Planifié');

-- Records of om_psector_cat_type
-- ----------------------------
INSERT INTO om_psector_cat_type VALUES (1,'Reconstruction');
INSERT INTO om_psector_cat_type VALUES (2,'Réhabilitation');

-- Records of value_review_validation table
-- ----------------------------
INSERT INTO value_review_validation VALUES (0, 'Rejeté');
INSERT INTO value_review_validation VALUES (1, 'Accepté');
INSERT INTO value_review_validation VALUES (2, 'A vérifier');

-- Records of value_review_status table
-- ----------------------------
INSERT INTO value_review_status VALUES (0, 'Aucun changement au-dessus ou au-dessous des valeurs de tolérance', 'Aucun changement');
INSERT INTO value_review_status VALUES (1, 'Nouveau élément inséré à la vérification', 'nouveau element');
INSERT INTO value_review_status VALUES (2, 'Géometrie modifié lors de la vérification. D autres éléments peuvent avoir été modifié ', 'Géometrie modifié');
INSERT INTO value_review_status VALUES (3, 'Changement dans les données, exception faite de la geometrie', 'Donnée modifiée');

-- Records of sys_csv2pg_cat table
-- ----------------------------
INSERT INTO sys_csv2pg_cat VALUES (1, 'Import prix BD', 'Import prix BD', 
'Le fichier csv doit contenir les colonnes suivantes aux mêmes positions : id, unit, descript, text, price. 
...
- Attention, le fichier csv nécessite une ligne d en-tête', 'role_master');
