...
-- ----------------------------
INSERT INTO doc_type VALUES ('DOCUMENTOS(PDF)');
INSERT INTO doc_type VALUES ('FOTOS(PNG,JPG,JPEG,BMP)');
...
-- ----------------------------
INSERT INTO value_priority VALUES ('PRIORITAT ALTA');
INSERT INTO value_priority VALUES ('PRIORITAT NORMAL');
INSERT INTO value_priority VALUES ('PRIORITAT BAIXA');

-- Records of plan_result_type
-- ----------------------------
INSERT INTO plan_result_type VALUES (1,'Reconstrucció');
INSERT INTO plan_result_type VALUES (2,'Rehabilitació');

-- Records of plan_psector_cat_type
-- ----------------------------
INSERT INTO plan_psector_cat_type VALUES (1,'Planificat');

-- Records of om_psector_cat_type
-- ----------------------------
INSERT INTO om_psector_cat_type VALUES (1,'Reconstrucció');
INSERT INTO om_psector_cat_type VALUES (2,'Rehabilitació');

-- Records of value_review_validation table
-- ----------------------------
INSERT INTO value_review_validation VALUES (0, 'Rebutjat');
INSERT INTO value_review_validation VALUES (1, 'Aceptat');
INSERT INTO value_review_validation VALUES (2, 'A revisar');

-- Records of value_review_status table
-- ----------------------------
INSERT INTO value_review_status VALUES (0, 'No hi ha canvis per sobre o sota dels llindars de tolerancia', 'Sense canvis');
INSERT INTO value_review_status VALUES (1, 'Nou element introduit per revisar', 'Nou element');
INSERT INTO value_review_status VALUES (2, 'Geometria modificada en la revisió. Altre dates es poden haber modificat', 'Geometria modificada');
INSERT INTO value_review_status VALUES (3, 'Cavis en les dades, no en la geometria', 'Dades modificades');

-- Records of csv2pg cat table
-- ----------------------------
